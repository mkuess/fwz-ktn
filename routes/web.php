...
Route::middleware('registration.enabled:organisation_registration_enabled')
    ->prefix('registrieren')
    ->name('registrierung.')
    ->group(function () {
...
Route::middleware('registration.enabled:member_registration_enabled')->group(function () {
